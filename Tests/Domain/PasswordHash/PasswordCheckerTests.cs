...
//             _pwdChecker = new PasswordChecker(_pwdProvider, new CryptoAgent()) ;
//         }
...
//             var result = _pwdChecker.IsPasswordCorrect(right_password).GetAwaiter().GetResult() ;
...
//             // Call the check pipeline with the right password
//             var result = _pwdChecker.IsPasswordCorrect(wrong_password).GetAwaiter().GetResult() ;
...
//         {
//             // Call the check pipeline with the right password
//             _pwdChecker.IsPasswordCorrect("something").ShouldThrow(typeof(NoPasswordStoredException));
//         }
